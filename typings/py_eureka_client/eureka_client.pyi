...
from typing import Any, Callable, List, Literal, Optional, List, Union, Dict
...
class Applications:
    def __init__(self, apps__hashcode: str=..., versions__delta: str=..., applications: Optional[List[Application]] = ...):
...
class Application:
    def __init__(self, name: str="", instances: Optional[List[Instance]] = ...):
        self.name: str
...
def get_delta(eureka_server: str, regions: List[str]=[]): ...
def get_vip(eureka_server: str, vip: str, regions: List[str]=[]): ...
def get_secure_vip(eureka_server: str, svip: str, regions: List[str]=[]): ...
