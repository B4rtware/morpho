...
from typing import Any, Callable, Dict, List, Optional, Tuple, Type as TypingType, Union
from mypy.errorcodes import ErrorCode
from mypy.nodes import Argument, AssignmentStmt, ClassDef, Context, FuncBase, JsonDict, NameExpr, SymbolNode, TypeInfo, Var
...
class ModelConfigData:
    def __init__(self, forbid_extra: Optional[bool] = ..., allow_mutation: Optional[bool] = ..., orm_mode: Optional[bool] = ..., allow_population_by_field_name: Optional[bool] = ..., has_alias_generator: Optional[bool] = ...):
        self.forbid_extra = ...
        self.allow_mutation = ...
        self.orm_mode = ...
        self.allow_population_by_field_name = ...
        self.has_alias_generator = ...
...
def add_method(ctx: ClassDefContext, name: str, args: List[Argument], return_type: Type, self_type: Optional[Type] = ..., tvar_def: Optional[TypeVarDef] = ..., is_classmethod: bool = ..., is_new: bool = ...) -> None:
    """
