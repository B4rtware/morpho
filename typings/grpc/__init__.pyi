...
def unary_unary_rpc_method_handler(behavior, request_deserializer: Optional[Any] = ..., response_serializer: Optional[Any] = ...):
...
def unary_stream_rpc_method_handler(behavior, request_deserializer: Optional[Any] = ..., response_serializer: Optional[Any] = ...):
...
def stream_unary_rpc_method_handler(behavior, request_deserializer: Optional[Any] = ..., response_serializer: Optional[Any] = ...):
...
def stream_stream_rpc_method_handler(behavior, request_deserializer: Optional[Any] = ..., response_serializer: Optional[Any] = ...):
...
def ssl_channel_credentials(root_certificates: Optional[Any] = ..., private_key: Optional[Any] = ..., certificate_chain: Optional[Any] = ...):
...
def metadata_call_credentials(metadata_plugin, name: Optional[Any] = ...):
...
def ssl_server_credentials(private_key_certificate_chain_pairs, root_certificates: Optional[Any] = ..., require_client_auth: bool = ...):
...
def ssl_server_certificate_configuration(private_key_certificate_chain_pairs, root_certificates: Optional[Any] = ...):
...
def insecure_channel(target: str, options: Optional[Any] = ..., compression: Optional[str]=None) -> Channel:
...
def secure_channel(target, credentials, options: Optional[Any] = ..., compression: Optional[Any] = ...):
...
def server(thread_pool: futures.ThreadPoolExecutor, handlers: Optional[Sequence[GenericRpcHandler]]=None, interceptors: Optional[Sequence[ServerInterceptor]]=None, options: Optional[Dict[str, Any]]=None, maximum_concurrent_rpcs: Optional[int]=None, compression: Optional[str]=None) -> Server:
