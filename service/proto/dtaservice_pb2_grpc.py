...
from service.proto.dtaservice_pb2 import DocumentRequest, ListServiceRequest, TransformDocumentResponse, TransformPipeRequest
...
class DTAServerServicer(object):
  ...
  def ListServices(self, request: ListServiceRequest, context: ServicerContext):
