...
import service.proto.dtaservice_pb2 as dtaservice__pb2
...
class DTAServer(object):
    ...
    def TransformDocument(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/dtaservice.DTAServer/TransformDocument',
            dtaservice__pb2.DocumentRequest.SerializeToString,
            dtaservice__pb2.TransformDocumentResponse.FromString,
    ...
    def ListServices(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/dtaservice.DTAServer/ListServices',
            dtaservice__pb2.ListServiceRequest.SerializeToString,
            dtaservice__pb2.ListServicesResponse.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def TransformPipe(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/dtaservice.DTAServer/TransformPipe',
            dtaservice__pb2.TransformPipeRequest.SerializeToString,
            dtaservice__pb2.TransformDocumentResponse.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
